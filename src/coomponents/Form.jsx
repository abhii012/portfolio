...
function Form() {
  ...
  return (
    <Element name='contact'className='bg-gradient-to-br from-[#000000] to-cyan-800'>
    <form onSubmit={handleSubmit(onSubmit) } className='max-w-xs sm:max-w-md mx-auto mt-8 min-h-screen pt-30 sm:pt-20 '>
      <h1 className='text-center text-xl sm:text-4xl text-slate-200 mb-5'>Connect With ME</h1>
      <div  className=' form-box bg-[#18181899] backdrop-blur-2xl rounded-lg min-h-[70vh] sm:min-h-[70vh] p-2 sm:p-5 text-white  scale-80 sm:scale-100  border-0.5 border-cyan-400 shadow-[0_0_20px_0px_rgba(6,182,212,0.75)]'>
